---
name: 06-static-routing
description: Planejar, configurar e validar rotas estáticas IPv4 e IPv6 no Cisco ASR1001-X com rollback exato.
---
...
Adicionar ou alterar rota somente após validar next-hop e recursão.
...
- [INFERIDO] `ip route <PREFIX> <MASK> <NEXT_HOP>`
...
Ler rota atual/CEF; descobrir sintaxe e distância com `?`; analisar blackhole, floating static e recursão; mostrar prefixos afetados; obter confirmação; validar RIB/FIB.
...
Default ou rota mais específica pode desviar todo o tráfego.

## Rollback

Registrar a linha anterior e usar sua negação exata somente após discovery; restaurar rota substituída.
