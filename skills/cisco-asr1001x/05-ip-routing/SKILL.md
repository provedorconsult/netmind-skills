---
name: 05-ip-routing
description: Analisar RIB, FIB, CEF e resolução recursiva IPv4 e IPv6 no Cisco ASR1001-X.
---
...
Confirmar por que um prefixo encaminha ou falha.
...
- [INFERIDO] `show ip route <PREFIX>`
- [INFERIDO] `show ip route summary`
- [INFERIDO] `show ip cef`
- [INFERIDO] `show ip cef <PREFIX>`
- [INFERIDO] `show ipv6 route`
- [INFERIDO] `show ipv6 cef`
...
Registrar origem, distância, métrica, next-hop, interface, recursão e adjacência CEF; comparar RIB e FIB.
...
Rota na RIB não garante encaminhamento se a recursão/CEF/ARP/ND falhar.

## Rollback

Nenhuma mudança nesta Skill.
