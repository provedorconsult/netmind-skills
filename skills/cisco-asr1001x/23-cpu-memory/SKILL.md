---
name: 23-cpu-memory
description: Diagnosticar CPU, processos, memória e recursos de plataforma no Cisco ASR1001-X.
---
...
Separar pico transitório, saturação sustentada, leak e pressão de forwarding.
...
- [INFERIDO] `show processes cpu sorted`
- [INFERIDO] `show processes memory`
- [INFERIDO] `show memory statistics`
- [INFERIDO] `show platform resources`
...
Registrar janela/uptime; correlacionar processo com BGP, NAT, QoS, PPPoE, CEF ou ataque; comparar control plane e data plane quando a release oferecer comandos.
...
Comandos detalhados/debug podem elevar carga; não executar debug sem plano.

## Rollback

Somente leitura; não matar processo/reload.
