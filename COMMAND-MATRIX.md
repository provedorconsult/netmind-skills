...
| `display statistics service-port 1000` | User/System view | Contadores do fluxo | [CONFIRMADO] | Baixo |
...
| `gem mapping 1 1 vlan 100` | Line profile | Mapear VLAN/flow ao GEM | [CONFIRMADO][DESTRUTIVO] | Alto |
| `undo gem mapping 1 1` | Line profile | Remover mapping específico | [CONFIRMADO][DESTRUTIVO] | Alto |
